...
| **23** | `PENDING` | 2026-09-25 | `src/services/ai-career-coach.ts`, `src/app/api/career-coach/route.ts`, `src/app/career-coach/page.tsx` | Career Coach chatbot integration | Implement "HireLens Career Coach" with Gemini/OpenAI API fallback, prompt pills, STAR bullet advice, and interactive chat interface |
