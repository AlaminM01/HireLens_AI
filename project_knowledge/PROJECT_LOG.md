...
| **25** | `PENDING` | 2026-09-25 | `src/services/job-matcher.ts`, `src/app/job-match/page.tsx` | Job description matching system | Implement custom JD parser, match percentage calculation, keyword deficit badges, and tailoring recommendations |
