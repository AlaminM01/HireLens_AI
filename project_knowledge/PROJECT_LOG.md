...
| **17** | `PENDING` | 2026-09-25 | `src/services/resume-parser.ts` | Resume parsing engine | Build NLP parsing heuristics, candidate metadata regexes, skill dictionary taxonomy, and section chunking |
