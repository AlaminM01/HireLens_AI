...
| **15** | `PENDING` | 2026-09-25 | `src/app/login/page.tsx`, `src/app/signup/page.tsx` | Create login and signup flows | Build glassmorphic authentication pages, 1-click recruiter/candidate demo access, role selectors, and form validations |
