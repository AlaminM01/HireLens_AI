...
| **16** | `PENDING` | 2026-09-25 | `src/lib/mock-resumes.ts`, `src/components/resume/ResumeUploader.tsx`, `src/app/upload/page.tsx` | Resume upload module | Implement drag-and-drop file ingestion, simulated multi-stage ATS pipeline, 5 mock sandbox profiles, and file metadata extraction |
